...
- Create file `gradle.properties` in `easy-repo-local` directory with following content
    ...
    ```
 - Alternatively, you can create your repository on GitHub by clicking [Here](https://github.com/new?template_name=easy-repository-template&template_owner=apanwar)
